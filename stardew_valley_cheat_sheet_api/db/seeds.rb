...
Game.create(farm_name: "Test Farm!", farm_type: "Wilderness Farm", pet_type: "Cat", user_id: 1)
Villager.create(name: "Abigail", birthday: "Fall 13", gifts: ["Amethyst", "Banana Pudding", "Blackberry Cobbler", "Chocolate Cake", "Pufferfish", "Pumpkin", "Spicy Eel", "Gemstones"], hearts: 14, marriage: true, game_id: 1 )
Animal.create(name: "blue chicken", cost: 800, requirements: "Shanes 8 heart event, Coop", produce: "Egg, Large Egg", sell_price: 1040, game_id: 1)
Building.create(name: "Big Coop", cost: "400 Wood, 150 Stone, 10,000g", game_id: 1)
Crop.create(name: "Coffee Bean", season: "Spring, Summer", grow_time: "10 days, regrowth 2", sell_price: "15-30g", uses: "inedible, coffee", cost: "2,500g from traveling cart, or from dust sprite", game_id: 1)
