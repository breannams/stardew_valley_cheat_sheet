...
render (){
    return (
        ...
        <br></br>
        <br></br>
                Hello! To use this page please login / sign up first! Afterwards you can create your own farm and learn about different villagers, buildings, etc. from Stardew Valley.
